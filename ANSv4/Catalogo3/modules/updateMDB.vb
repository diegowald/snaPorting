...
Namespace Funciones
    ...
    Public Class updateMDB

        ' Define como se llama este modulo para el control de errores
        Private Const m_sMODULENAME_ As String = "updateMDB"

        Public Shared Sub Emergencia(ByVal db As String)
        ...
        Public Shared Sub CambiarLinks(ByVal db As String)
...
ErrorGuardianLocalHandler:
        ...
        Private Shared Sub ProcesarTablasLinks(ByRef Conexion As ADODB.Connection, db As String)
