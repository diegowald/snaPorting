...
Public Class Auditor
    ...
    Private _AuditarProceso As Boolean
...
ErrorHandler:
    ...
    Public WriteOnly Property AuditarProceso() As Boolean
        Set(ByVal value As Boolean)
            _AuditarProceso = value
        End Set
    End Property
