...
namespace Catalogo.reportes {
    ...
    public class Pedido_Enc4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Catalogo.reportes.Pedido_Enc4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPedido_Enc4 : Component, ICachedReport {
        
        public CachedPedido_Enc4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Pedido_Enc4 rpt = new Pedido_Enc4();
            rpt.Site = this.Site;
            return rpt;
        }
