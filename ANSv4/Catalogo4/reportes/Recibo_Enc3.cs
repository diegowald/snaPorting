...
namespace Catalogo.reportes {
    ...
    public class Recibo_Enc3 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Catalogo.reportes.Recibo_Enc3.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRecibo_Enc3 : Component, ICachedReport {
        
        public CachedRecibo_Enc3() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Recibo_Enc3 rpt = new Recibo_Enc3();
            rpt.Site = this.Site;
            return rpt;
        }
